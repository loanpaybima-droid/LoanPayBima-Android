...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.customerPaymentBtn.setOnClickListener {
            openExternal("https://rzp.io/rzp/LPBCustomerServiceRequest")
        }
        binding.websiteBtn.setOnClickListener {
            openWeb("LoanPayBima", "https://loanpaybima.in/")
        }
        binding.whatsappBtn.setOnClickListener {
            openExternal("https://wa.me/919325280889?text=Hello%20LoanPayBima%2C%20mujhe%20insurance%20assistance%20chahiye.")
        }
    }
